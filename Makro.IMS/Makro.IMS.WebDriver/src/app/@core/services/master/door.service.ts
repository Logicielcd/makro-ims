...
export class DoorService {
  ...
  getByWarehouse(warehouseCode: string): Observable<Door[]> {    
    return this.apiService.get(`${this.apiController}/warehouse/${warehouseCode}`);    
  }

  getById(internalDoorId: number): Observable<Door> {    
    return this.apiService.get(
      `${this.apiController}/${internalDoorId}`
    );
  }

  getByWarehouseAndSupCode(warehouseCode: string,supCode: string): Observable<Door[]> {    
    return this.apiService.get(`${this.apiController}/warehouse/${warehouseCode}/${supCode}`);    
  }

  getByWarehouseAndOperation(warehouseCode: string,operationType: string,internalTruckCheckinId: number): Observable<Door[]> {    
    return this.apiService.get(`${this.apiController}/operation/${warehouseCode}/${operationType}/${internalTruckCheckinId}`);    
  }
  ...
  delete(doorId: number) {    
    return this.apiService.post(
      `${this.apiController}/delete`,{doorId}
    );      
  }
