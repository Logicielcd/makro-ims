...
export class TablePageListComponent implements OnInit, AfterContentChecked {
  ...
  loadData(event: LazyLoadEvent) {
    // if(this.pagingService.isBack === true){
    //   console.log(this.first);
    //   this.first = ((this.pagingService.curPage - 1) * this.pagingService.pageSize);
    //   this.rows = this.pagingService.pageSize;
      
    //   this.lazyEvent = event;
      
    //   this.pagingService.loadPage(event);
    // }
    // else{
    //   if (event) {
    //     this.lazyEvent = event;
