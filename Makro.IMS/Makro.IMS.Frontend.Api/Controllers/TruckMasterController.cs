        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "truckmaster", this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        List<TruckMaster> d = Newtonsoft.Json.JsonConvert.DeserializeObject<List<TruckMaster>>(resultData);
