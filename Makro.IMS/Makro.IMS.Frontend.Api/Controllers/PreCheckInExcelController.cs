...
namespace Makro.IMS.Frontend.Api.Controllers
{
    ...
    {        
        ...
        [HttpPost("import")]
        public async Task<IActionResult> Import([FromBody] PreCheckInExcelDto preCheckInExcelDto)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "precheckinexcel/import", preCheckInExcelDto, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        PreCheckInExcelDto d = Newtonsoft.Json.JsonConvert.DeserializeObject<PreCheckInExcelDto>(resultData);
