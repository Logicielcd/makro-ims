        ...
        public async Task<IActionResult> Post([FromBody] BookingKeyDto bookingKey)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingKey", bookingKey, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> UpdateBooking([FromBody] BookingKeyDto bookingKey)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingKey/updateBooking", bookingKey, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingKey/" + id.ToString(), this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        BookingKeyDto d = Newtonsoft.Json.JsonConvert.DeserializeObject<BookingKeyDto>(resultData);
