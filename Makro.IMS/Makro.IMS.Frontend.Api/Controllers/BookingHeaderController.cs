...
namespace Makro.IMS.Frontend.Api.Controllers
{
    ...
    public class BookingHeaderController : ApiControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader", this.Request.Headers.Authorization[0].Replace("Bearer", "").Replace("bearer",""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        List<BookingHeader> d = Newtonsoft.Json.JsonConvert.DeserializeObject<List<BookingHeader>>(resultData);
        ...
        public async Task<IActionResult> GetPages([FromQuery] SieveModel sieveModel)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/pages",sieveModel, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer",""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        PagedResult<BookingHeader> d = Newtonsoft.Json.JsonConvert.DeserializeObject<PagedResult<BookingHeader>>(resultData);
        ...
        [HttpGet("precheckinpages")]
        public async Task<IActionResult> GetPreCheckInPages([FromQuery] SieveModel sieveModel)
        {
            string userName = this.User.Identities.FirstOrDefault().Name;
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/precheckinpages", sieveModel, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        [HttpGet("precheckinpagesexport")]
        public async Task<IActionResult> GetPreCheckInPagesExport([FromQuery] SieveModel sieveModel)
        {
            string userName = this.User.Identities.FirstOrDefault().Name;
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/precheckinpagesexport", sieveModel, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        PagedResult<BookingHeaderDto> d = Newtonsoft.Json.JsonConvert.DeserializeObject<PagedResult<BookingHeaderDto>>(resultData);
        ...
        [HttpGet("precheckincompletedpages")]
        public async Task<IActionResult> GetPreCheckInCompletedPages([FromQuery] SieveModel sieveModel)
        {
            string userName = this.User.Identities.FirstOrDefault().Name;
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/precheckincompletedpages", sieveModel, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetDashboard(string warehouseCode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/dashboard/" + warehouseCode, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/" + id.ToString(), this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
                    ...
                    if (resultPdiToken.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        BookingHeader d = Newtonsoft.Json.JsonConvert.DeserializeObject<BookingHeader>(resultData);
        ...
        public async Task<IActionResult> GetByPo(string poNo, string supCode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getByPo/" + poNo + "/" + supCode, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetByBooking(string bookingId, string supCode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getByBooking/" + bookingId + "/" + supCode, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetBookingByBooking(string bookingId)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getBookingByBooking/" + bookingId , this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetPoCheckIn(string supCode, string warehouseCode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getPoCheckIn/" + supCode + "/" + warehouseCode, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetByBookingHeaderKey(int bookingHeaderKey, string supCode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getByBookingHeaderKey/" + bookingHeaderKey.ToString() + "/" + supCode, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> GetBySupAndBookingDate(string supCode, DateTime bookingDate)
        {
            ...
            try
            {
                ...
                try
                {
                    var resultPdiToken = Service.HttpApiService.Get(apiUrl, "bookingheader/getBySupAndBookingDate/" + supCode + "/" + bookingDate.ToLocalTime().ToString("yyyy-MM-ddThh:mm:ss.000Z")
                        , this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> CheckIn([FromBody] BookingTruckCheckInDto bookingCheckIn)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/checkin",bookingCheckIn, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> CheckInPo([FromBody] CheckInDto checkIn)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/checkinpo", checkIn, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
        ...
        public async Task<IActionResult> CheckInBooking([FromBody] CheckInDto checkIn)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultPdiToken = Service.HttpApiService.Post(apiUrl, "bookingheader/checkinbooking", checkIn, this.Request.Headers.Authorization[0].Replace("bearer", "").Replace("Bearer", ""));
                    var resultData = "";
