...
export class BookingHeaderService {
  ...
  backhaulBooking(backhaulBooking: BackhaulBooking): Observable<boolean> {    
    return this.apiService.post(
      `${this.apiController}/backhaulbooking/`,
       backhaulBooking
    );      
  }

  dcDelayBooking(dcDelayBooking: DcDelayBooking): Observable<boolean> {    
    return this.apiService.post(
      `${this.apiController}/dcdelaybooking/`,
       dcDelayBooking
    );      
  }

  bookingLog(internalTruckCheckInId:number): Observable<BookingTruckLog[]>{
    return this.apiService.get(
      `${this.apiController}/bookinglog/${internalTruckCheckInId}`
    );      
  }

  cancelBooking(bookingHdr: BookingHeaderDto): Observable<boolean> {    
    return this.apiService.post(
      `${this.apiController}/cancelbooking/`,
       bookingHdr
    );      
  }
