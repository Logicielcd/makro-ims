...
import { GuardCheckInOutDto, ManualBookingDto } from '@core/models/booking/check-in-out.model';
...
export class GuardCheckInOutService {
  ...
  manualBooking(manualBooking: ManualBookingDto): Observable<any> {    
    return this.apiService.post(
      `${this.apiController}/manualbooking/`,{ 
        ...manualBooking,
      });
  }
