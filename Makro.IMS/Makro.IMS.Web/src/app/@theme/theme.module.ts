...
import { SlotTimeModalComponent } from './components/modal/slot-time-modal/slot-time-modal.component';
import { PoDialogComponent } from './components/modal/po-dialog/po-dialog.component';
