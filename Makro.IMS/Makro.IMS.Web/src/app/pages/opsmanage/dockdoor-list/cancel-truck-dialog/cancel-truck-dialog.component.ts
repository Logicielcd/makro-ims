...
@UntilDestroy()
@Component({  
  templateUrl: 'cancel-truck-dialog.component.html',
  styleUrls: ['cancel-truck-dialog.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class CancelTruckDialogComponent implements OnInit {
  msgs: Message[] = [];
  cols: any[];
  ...
  onConfirm(){
    ...
    this.manageQueueService.cancelDoor(queueAction)
