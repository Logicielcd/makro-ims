...
@UntilDestroy()
@Component({
  templateUrl: './guard-check-out.component.html',
})
export class GuardCheckOutComponent implements OnInit {
  ...
  onGatePass(){
    this.guardCheckInOutService.getGuardCheckOut(this.gatePass)
    .pipe(untilDestroyed(this))
    .subscribe({next:(data) =>{
