...
@UntilDestroy()
@Component({  
  templateUrl: 'unload-finish-dialog.component.html',
  styleUrls: ['unload-finish-dialog.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class UnloadFinishDialogComponent implements OnInit {
  ...
  {    
    this.remark = "";
    this.waitingDoc = "";
    this.visibleCancelPoDialog = false;
    this.cols = [      
  ...
  onConfirm()
  {
    ...
    queueAction.status = this.waitingDoc;
    queueAction.remark = this.remark;
    queueAction.queueNo = '0';
    this.manageQueueService.unloadFinish(queueAction)
  ...
  onCancelPo(){
    this.visibleCancelPoDialog = true;
